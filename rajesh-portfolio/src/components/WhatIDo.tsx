        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                training, evaluation, and Streamlit deployment for real-world
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">KNIME</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Insights Through Visualization</h4>
              <p>
                Transforming raw datasets into meaningful dashboards and
                business insights. Skilled in statistical analysis, data
                visualization, SQL, and BI platforms for data-driven
                decision-making.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
